...
namespace RP0
{
    ...
    public class GUIDataSaver
    {
        ...
        public void Save()
        {
            ...
            try
            {
                buildListPositionSaved = new GUIPosition("buildList", KCT_GUI.BuildListWindowPosition.x, KCT_GUI.BuildListWindowPosition.y, SpaceCenterManagement.ShowWindows[0]);
                editorPositionSaved = new GUIPosition("editor", KCT_GUI.EditorWindowPosition.x, KCT_GUI.EditorWindowPosition.y, SpaceCenterManagement.ShowWindows[1]);
        ...
        public void Load()
        {
            ...
            try
            {
                ...
                if (buildListPositionSaved != null)
                {
                    ...
                    SpaceCenterManagement.ShowWindows[0] = buildListPositionSaved.visible;
                }
                ...
                if (editorPositionSaved != null)
                {
                    ...
                    SpaceCenterManagement.ShowWindows[1] = editorPositionSaved.visible;
                }
