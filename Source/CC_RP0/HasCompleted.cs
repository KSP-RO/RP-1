...
namespace ContractConfigurator.RP0
{
    ...
    public class HasCompleted : VesselParameter
    {
        ...
        protected override bool VesselMeetsCondition(Vessel vessel)
        {
            ...
            bool result = RP1ContractTracker.Instance.ContractTracker.TryGetValue(vessel.GetKCTVesselId(), out List<string> contracts)
                            && contracts.Intersect(ContractTags).Any();
