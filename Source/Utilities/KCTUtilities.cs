...
namespace RP0
{
    public static class KCTUtilities
    {
        ...
        public static void TryAddVesselToBuildList(string launchSite)
        {
            ...
            if ((type == BuildListVessel.ListType.VAB) != (KerbalConstructionTimeData.Instance.ActiveKSC.ActiveLaunchComplexInstance.LCType == LaunchComplexType.Pad))
            {
                string dialogStr;
            ...
            else
            {
                ...
                if (oldFac != KerbalConstructionTime.Instance.EditorVessel.FacilityBuiltIn)
                {
                    if (oldFac == EditorFacility.VAB)
                    {
                        ...
                        {
                            KerbalConstructionTimeData.Instance.ActiveKSC.SwitchLaunchComplex(KSCItem.HangarIndex);
                        }
                    }
                    else
                    {
