...
namespace RP0InstallChecker
{
    ...
    public class InstallChecker : MonoBehaviour
    {
        ...
        protected void Update()
        {
            ...
            {
                string titleText = "Incorrect RP-1 Installation";
                string contentText = "One or more critical dll files is missing. This could be caused by downloading the RP-1 repo or some specific branch directly from GitHub, or by not installing or not updating dependencies. " +
